...
std::string RPL_INVITED(Client *client, std::string invited, std::string channel){return ":" + client->getNick() + "!" + client->getUser() + "@" + client->getIPaddr() + " INVITE " + invited + " " + channel + "\r\n";}
std::string RPL_INVITING(Client *client, std::string invited, std::string channel){return ": 341 " + client->getNick() + " " + invited + " " + channel + "\r\n";}
...
std::string	RPL_MODE(Client *client, std::string channel, std::string mode, std::string target){return ":" + client->getNick() + "!" + client->getUser() + " MODE " + channel + " " + mode + target + "\r\n";}
std::string RPL_SETTOPIC(Client *client, std::string channel, std::string topic){return ":" + client->getNick() + "!" + client->getUser() + " TOPIC " + channel + " " + topic + "\r\n";}
std::string RPL_TOPIC(Client *client, std::string channel, std::string topic){return ": 332 " + client->getNick() + " " + channel + " " + topic + "\r\n";}
// :mneri!mneri INVITE mneri #foo
// : 341 mneri_ mneri #foo