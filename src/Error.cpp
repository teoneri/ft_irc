...
/*   Updated: 2024/06/05 18:10:19 by teo              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string	RPL_MODE(Client *client, std::string channel, std::string mode, std::string target){return ":" + client->getNick() + "!" + client->getUser() + " " + channel + " " + mode + target + "\r\n";}
